...
- fully rewrited interface of TableParams
...
For a list of configuration options available, see [Configuring your table with TableParams](https://github.com/esvit/ng-table/wiki/Configuring-your-table-with-TableParams)
